    ...
    <nav class="navbar navbar-expand-md bg-body-tertiary">
        <div class="container-fluid px-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="d-flex mt-3 mt-md-0 form-width" name="searchForms" style="gap: .5rem; position: relative;" method="GET" action="{{ route('all-plants.search') }}">
                    <input class="form-control rounded-3 border-neutral-200 h-[2.30rem]" id="search" type="search" placeholder="Search" aria-label="Search" name="search" value="{{ Route::currentRouteNamed('home.show') ? '' : old('search') }}">
