                        ...
                        <div class="flex flex-col xl:flex-row items-start gap-4 xl:gap-4 p-4 w-full">
                            <div class="flex flex-col gap-2 w-full">
                                ...
                                <div class="flex flex-row justify-between">
                                    <p class="text-black text-opacity-50 text-xl">{{ $cartItem->product->height }}cm</p>
                                    <p class="text-black text-opacity-75 text-xl">{{ $cartItem->product->price }} €/ks</p>
                                </div>
                            </div>
                            <div
                                ...
                                <button class="order-none sm:order-1 size-12 rounded-xl relative flex items-center justify-center bg-red-500">
