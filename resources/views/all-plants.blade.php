...
<script>
    ...
    function changeQuantity(button, direction) {
        const form = button.closest('form'); // Find closest form which contains the button
        const input = form.querySelector('.quantity-input'); // Find the quantity input within the same form
